                            ...
                            <div class="card-body row justify-content-center">
                                ...
                                <div class="col-lg-12 mb-1">
                                    <button type="button" class="btn btn-warning mr-2" onclick="ajaxAllDelete(this, 'dt')"
                                        data-route="{{ route('admin.delete_all', 'Customer') }}" data-bs-placement="top" data-bs-toggle="tooltip"  data-bs-original-title="@lang('app.soft-delete-alert')" title="@lang('app.soft-delete-alert')">
                                        <i class="fa-solid fa-trash-arrow-up"> </i> @lang('app.delete')
                                    </button>
                                    <button data-route="{{ route('admin.force_delete_all', 'Customer') }}"
